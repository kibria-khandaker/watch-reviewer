            ...
            <div className='max-w-screen-xl mx-auto p-2 md:p-4'>
                <div className='w-auto md:w-4/6 mx-auto'>
                    ...
                    <div className='py-10'>
                        ...
                        <img className='  py-6 md:px-6 ' src="https://dmitripavlutin.com/90649ae4bdf379c482ad24e0dd220bc4/react-context-3.svg" alt="" />
                    ...
                    <div className='py-10'>
                        ...
                        <img className='mx-auto  py-8 md:px-6 ' src="https://www.w3schools.com/html/img_sem_elements.gif" alt="" />
